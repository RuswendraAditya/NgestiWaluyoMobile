...
public class DokterAntrianPickerActivity extends AppCompatActivity {
    DatabaseHandler db;
    ...
    public void onItemClick(AdapterView<?> parent,
        ...
        if (!dokter.getPraktek().isEmpty()&& dokter.getPraktek().equals("false")) {
            ...
            dialogAlert.alertValidationWithJadwal(DokterAntrianPickerActivity.this, "Peringatan", dokter.getResponse(), dokter.getNid(), dokter.getNamaDokter());
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        else if(kodeKlinik.equals("") && kodeDokter.equals(""))
        {
            ...
            DialogAlert dialogAlert = new DialogAlert();
            dialogAlert.alertValidation(DokterAntrianPickerActivity.this, "Peringatan", "Mohon Maaf tidak Mendapatkan Data Dokter, mohon dicoba kembali");
        }
        ...
        editDokterSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                adapter = new DokterListAdapter(dokterListTemp, DokterAntrianPickerActivity.this);
    ...
    private class DokterKlinikTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(DokterAntrianPickerActivity.this,
                    "Please Wait",
                    "Get Data Dokter");
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (dokterList.size() > 0) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        adapter = new DokterListAdapter(dokterList, DokterAntrianPickerActivity.this);
                        listDokter.setAdapter(adapter);
                    }
                });
            }
