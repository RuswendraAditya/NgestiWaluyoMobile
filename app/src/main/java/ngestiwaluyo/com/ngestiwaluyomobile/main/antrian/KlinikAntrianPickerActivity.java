...
public class KlinikAntrianPickerActivity extends AppCompatActivity {
    ...
    public void onItemClick(AdapterView<?> parent,
        ...
        if (!klinik.getPraktek().isEmpty()&& klinik.getPraktek().equals("false")) {
            ...
            dialogAlert.alertValidationWithJadwal(KlinikAntrianPickerActivity.this, "Peringatan", klinik.getResponse(), kodeDokter, namaDokter);
        } else {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db = new DatabaseHandler(KlinikAntrianPickerActivity.this);
        ...
        editKlinikSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                adapter = new KlinikListAdapter(klinikListTemp, KlinikAntrianPickerActivity.this);
    ...
    private class KlinikTask extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            progressDialog = ProgressDialog.show(KlinikAntrianPickerActivity.this,
                    "Please Wait",
                    "Get Data Klinik");
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            if (klinikList.size() > 0) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        adapter = new KlinikListAdapter(klinikList, KlinikAntrianPickerActivity.this);
                        listKlinik.setAdapter(adapter);
                    }
                });
            }
    ...
    private void getKlinikByDokter() {
        try {
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    DialogAlert dialogAlert = new DialogAlert();
                    dialogAlert.alertValidation(KlinikAntrianPickerActivity.this, "Peringatan", "Mohon Maaf tidak Mendapatkan Data Klinik, mohon dicoba kembali");
                }
            });
        }
